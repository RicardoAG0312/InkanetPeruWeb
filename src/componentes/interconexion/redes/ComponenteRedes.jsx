        ...
        <>
            ...
            <section className='componente-textos-interconexion text-black container-fluid p-5 h-auto bg-white'>
                <Informacion
                    ...
                    texto1="El servicio de interconexión de sedes del cliente se brinda a través de enlaces dedicados de fibra óptica desde el nodo de acceso de la red Backbone de Grupo Inkanet hasta las sedes del cliente.Permite la transferencia de información entre las sucursales sin discriminar el tipo de aplicaciones, útiles para el acceso rápido a servicios ubicados en las sedes principales, centralizar la salida a Internet y compartir otros recursos de red perimetral."
                    texto2=""
                    ...
                    texto4="Estas interconexiones se pueden brindar a través de la red de Grupo Inkanet, dedicada 100% a tráfico corporativo de altas velocidades."
                />
            </section>
