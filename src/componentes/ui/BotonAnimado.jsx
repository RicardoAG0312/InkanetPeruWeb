...
function BotonAnimado({colorIconoBase, colorLetraBase, colorBordeBase, colorIconoPress, fondoTextoPress, colorLetraPress, nav}) {
    ...
    return (
        <div style={{ position: "relative", display: "flex", alignItems: "center", height: "40px", maxWidth: "180px", borderRadius: "40px", border: `1px solid ${colorBordeBase}`, paddingRight: "10px", paddingLeft: "10px", overflow: "hidden", cursor: "pointer" }} 
        onMouseEnter={(e) => { 
